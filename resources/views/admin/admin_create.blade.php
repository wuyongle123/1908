...
<form class="form-horizontal" role="form" action="{{url('/admin_store')}}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="password" class="form-control" id="admin_pwd" name="admin_pwd" placeholder="请输入管理员密码">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="password" class="form-control" id="admin_pwds" name="admin_pwds">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" id="admin_tel" name="admin_tel" placeholder="请输入管理员手机号">
            <b style="color: red"></b>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" id="admin_email" name="admin_email" placeholder="请输入管理员邮箱">
            <b style="color: red"></b>
        </div>
    </div>
